...
public class PLaw implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -3196623954724363660L;
	...
	public String toString() {
		return "PLaw [shumingID=" + shumingID + ", teacherId=" + teacherId + ", Name=" + Name + ", Sex=" + Sex
