...
public class PBook implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5408076967198536076L;
	...
	public String toString() {
		return "PBook [shumingID=" + shumingID + ", teacherId=" + teacherId + ", Name=" + Name + ", Sex=" + Sex
				+ ", Kind=" + Kind + ", Education=" + Education + ", Job=" + Job + ", Unit=" + Unit + ", WRole=" + WRole
				+ ", Count=" + Count + ", Contribution=" + Contribution + "]";
	}
