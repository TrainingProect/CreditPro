...
public class PRRule implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -431021541243764454L;
	...
	public String toString() {
		return "PRRule [shumingID=" + shumingID + ", teacherId=" + teacherId + ", Name=" + Name + ", Sex=" + Sex
