...
public class Team implements Serializable{
	...
	public String toString() {
		return "Team [Id=" + Id + ", name=" + name + ", kind=" + kind + ", allNumber=" + allNumber + ", numb1=" + numb1
				+ ", numb2=" + numb2 + ", numb3=" + numb3 + ", numb4=" + numb4 + ", numb5=" + numb5 + ", numb6=" + numb6
				+ ", Atime1=" + Atime1 + ", Status1=" + Status1 + "]";
	}
