...
public class PIdentify implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 5473525943486513739L;
	@Id
	@GeneratedValue
	...
	public String toString() {
		return "PIdentify [shumingID=" + shumingID + ", teacherId=" + teacherId + ", Name=" + Name + ", Sex=" + Sex
